...
def build():
    ...
    # --- condition pages ---
    # hero image framing (object-position) per condition, tuned via preview
    HERO_POS = {
        "adhd": "54% 10%",
        "anxiety": "53% 100%",
        "bipolar-disorder": "50% 81%",
        "depression": "50% 100%",
        "ocd": "50% 0%",
        "perinatal-mental-health": "50% 22%",
        "ptsd": "50% 32%",
        "schizophrenia": "50% 50%",
        "sleep-disorders": "0% 70%",
        "substance-use-disorders": "50% 95%",
        "womens-mental-health": "50% 100%",
    }
    for c in CONDITIONS:
        ...
        body = (
            ...
            .replace("{{HEROPOS}}", HERO_POS.get(c["slug"], "50% 50%"))
